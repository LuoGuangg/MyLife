		...
		<div style="padding: 15px;">
				...
				<div class="personForm">
	  				<form:form modelAttribute="person" method="post" action="${ctx}/person/personSave.html" onsubmit="return checkPerson();">
	  					<form:input path="name" id="name" placeholder="姓名："/><br />
	  					...
	  					<form:input path="phone" id="phone" placeholder="电话：" /><br />
	  					<form:input path="qq" id="qq" placeholder="QQ：" /><br />
	  					<form:input path="birth" id="birth" placeholder="生日："  /><br />
	  					<input type="submit" id="save" value="添加人物" /><br />
	  				</form:form>
	  			</div>
