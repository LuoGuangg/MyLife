...
public class MyIntercepotr implements Interceptor, org.apache.ibatis.plugin.Interceptor{
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		//通过反射获取当前RoutingStatementHandler对象的delegate属性
		StatementHandler delegate = (StatementHandler)ReflectUtil.getFieldValue(handler, "delegate");
		
		BoundSql boundSql = delegate.getBoundSql();
		//拿到当前绑定sql的参数对象，就是调用Mapper映射语句所传入的参数对象
		Object obj = boundSql.getParameterObject();
		Page<Object> page =  (Page<Object>)ReflectUtil.getFieldValue(obj,"page");
		...
		if(page != null){
			...
			//拦截到的perpare方法参数是一个Connection对象
			Connection connection = (Connection)invocation.getArgs()[0];
			
			//获取Mapper映射语句中写的sql语句
			...
			//利用反射设置当前BoundSql对应sql属性为我们建立好的分页Sql语句
    ...
    private String getCountSql(String sql) {  
       ...
       return "select count(1) from (" + sql + ") AS sel";  
    } 
