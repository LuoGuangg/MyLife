...
public class MessageContent  extends EntityBase<MessageContent>{
	...
	public String toString() {
		return "MessageContent [id="+super.getId()+",gameId=" + gameId + ", content=" + content + ", CreateBy=" + super.getCreateBy() + ", CreateDate=" + super.getCreateDate() + ", UpdateBy=" + super.getUpdateBy() + ", UpdateDate=" +  super.getUpdateDate()  + "]";
	}
